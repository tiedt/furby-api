...
namespace IdentityByExamples.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(string userModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Login(string userModel, string returnUrl = null)
        {
            if (!ModelState.IsValid)
            {
                return View(userModel);
            ...
            var result = await _signInManager.PasswordSignInAsync(userModel, userModel, false, false);
            if (result.Succeeded)
            {
